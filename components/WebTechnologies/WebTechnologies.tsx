      ...
      <VStack gap={5} paddingX={{ base: 0, md: 35 }}>
        ...
        <Slide direction="up">
          <Fade>
            ...
            >
              Our expertise covers a wide spectrum of web development
              technologies and frameworks, ensuring that we can tackle projects
              of any complexity. From HTML, CSS, and JavaScript for front-end
              development, to PHP, Python, and Ruby on Rails for back-end
              development, we have the proficiency to handle diverse
              requirements and deliver seamless solutions.
            </Text>
            <Text
              fontFamily="roboto"
              color="white"
              ...
              fontSize={{ base: '12px', md: '14px', lg: '16px' }}
            >
              Partner with us to unlock the full potential of your online
              presence. Our web development services are geared towards
              enhancing your digital footprint, attracting customers, and
              driving business growth. Contact us today to embark on a

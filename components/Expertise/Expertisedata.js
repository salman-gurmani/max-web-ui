import { OurExpertiseImages } from '@components/Images'
const ExpertiseData = [
  {
    title: 'Web',
    boxLineWidth: '25px',
    icon: OurExpertiseImages.webDev.src.src,
  ...
  },
  {
    title: 'Video Games',
    boxLineWidth: '100px',
    icon: OurExpertiseImages.gameDev.src.src,
  ...
  },
  {
    title: 'Services',
    boxLineWidth: '60px',
    icon: OurExpertiseImages.services.src.src,
